function ConvertTo-KSXml {
  ...
  #   By default ConvertTo-KSXML creates an attribute on each property element containing the .NET type. This behaviour may be suppressed by setting IncludeTypeNames to false.
  # .PARAMETER Object
  ...
  #   System.String
  # .EXAMPLE
  #   Get-Process | Select-Object ProcessName, StartTime, ID | ConvertTo-KSXml | Out-File processes.xml
  # .NOTES
  #   Author: Chris Dent
