function Get-KSCommandParameters {
  # .SYNOPSIS
  #   Get the parameters used by a command, excluding common parameters.
  # .DESCRIPTION
  #   Get-KSCommandParameters is used to retrieve the list of CmdLet-specific parameters to simplify parameter passing operations.
  # .PARAMETER Name
  ...
  # .EXAMPLE
  #   Get-KSCommandParameters Get-KSADObject
  # .NOTES
  #   Author: Chris Dent
  ...
  #     24/06/2014 - Chris Dent - First release.
