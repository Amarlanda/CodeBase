function New-KSDynamicParameter {
  # .SYNOPSIS
  #   Create a new dynamic parameter object for use with a dynamicparam block.
  # .DESCRIPTION
  #   New-KSDynamicParameter allows simplified creation of runtime (dynamic) parameters.
  ...
  # .EXAMPLE
  #   New-KSDynamicParameter Name -DefaultValue "Test" -ParameterType "String" -Mandatory -ValidateSet "Test", "Live"
  # .EXAMPLE
  #   New-KSDynamicParameter Name -ValueFromPipelineByPropertyName
  # .EXAMPLE
  #   New-KSDynamicParameter Name -ValidateRange 1, 2
  # .NOTES
  #   Author: Chris Dent
