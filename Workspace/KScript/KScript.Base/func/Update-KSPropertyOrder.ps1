function Update-KSPropertyOrder {
  # .SYNOPSIS
  #   Update the order of properties on an object.
  # .DESCRIPTION
  #   Update-KSPropertyOrder attempts to re-order the properties on an object into alphabetical order.
  #
  ...
  #
  #   Change log:
  #    04/12/2014 - Chris Dent - First release.
