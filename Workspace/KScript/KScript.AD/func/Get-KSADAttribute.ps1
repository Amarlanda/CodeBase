function Get-KSADAttribute {
  # .SYNOPSIS
  #   Get the definition of an attribute from the schema.
  # .DESCRIPTION
  #   Get-KSADAttribute gets attributes from the schema naming context.
  ...
  # .OUTPUTS
  #   KScript.AD.Attribute
  # .EXAMPLE
  #   Get-KSADAttribute
  # .EXAMPLE
  #   Get-KSADAttribute -ComputerName RemoteServer
  # .NOTES
  #   Author: Chris Dent
  ...
  if ($Name) {
    $LdapFilter = "(&(|(name=$Name)(lDAPDisplayName=$Name))(objectClass=attributeSchema))"
  }
  $Params.Add("LdapFilter", $LdapFilter)
  
  Get-KSADObject @Params | ForEach-Object {
    $_.PSObject.TypeNames.Add("KScript.AD.Attribute")
