function Import-KSADCustomProperty {
  # .SYNOPSIS
  #   Import the script at the specified path into the current module.
  # .DESCRIPTION
  #   Import-KSADCustomProperty records references to custom property scripts.
  #
  ...
  #   System.String
  # .EXAMPLE
  #   Import-KSADCustomProperty C:\Converters\LargeIntegerDate.ps1
  # .EXAMPLE
