function ReadKSDnsNIMLOCRecord {
  # .SYNOPSIS
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.NIMLOC
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.NIMLOC")
