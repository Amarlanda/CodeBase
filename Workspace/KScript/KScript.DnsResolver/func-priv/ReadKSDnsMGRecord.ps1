function ReadKSDnsMGRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.MG
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.MG")

  # Property: MailboxName
  $ResourceRecord | Add-Member Mailbox -MemberType NoteProperty -Value (ConvertToKSDnsDomainName $BinaryReader)
