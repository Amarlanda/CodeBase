function ReadKSDnsNSRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.NS
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.NS")
