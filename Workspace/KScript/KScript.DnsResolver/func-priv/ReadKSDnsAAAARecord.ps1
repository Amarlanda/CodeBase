function ReadKSDnsAAAARecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.AAAA
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.AAAA")
