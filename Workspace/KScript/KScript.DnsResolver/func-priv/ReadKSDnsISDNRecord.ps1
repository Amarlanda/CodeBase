function ReadKSDnsISDNRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.ISDN
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.ISDN")
  
  # Property: ISDNAddress
  $ResourceRecord | Add-Member ISDNAddress -MemberType NoteProperty -Value (ReadKSDnsCharacterString $BinaryReader)
  # Property: SubAddress
  $ResourceRecord | Add-Member SubAddress -MemberType NoteProperty -Value (ReadKSDnsCharacterString $BinaryReader)
