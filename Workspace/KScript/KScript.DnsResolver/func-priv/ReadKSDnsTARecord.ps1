function ReadKSDnsTARecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.TA
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.TA")
