function ReadKSDnsMFRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.MF
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.MF")
