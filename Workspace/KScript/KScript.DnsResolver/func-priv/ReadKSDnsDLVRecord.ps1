function ReadKSDnsDLVRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.DLV
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.DLV")
