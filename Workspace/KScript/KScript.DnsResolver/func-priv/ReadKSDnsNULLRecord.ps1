function ReadKSDnsNULLRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.NULL
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.NULL")
