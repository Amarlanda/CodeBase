function ReadKSDnsMINFORecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.MINFO
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.MINFO")
  
  # Property: ResponsibleMailbox
  $ResourceRecord | Add-Member ResponsibleMailbox -MemberType NoteProperty -Value (ConvertToKSDnsDomainName $BinaryReader)
  # Property: ErrorMailbox
  $ResourceRecord | Add-Member ErrorMailbox -MemberType NoteProperty -Value (ConvertToKSDnsDomainName $BinaryReader)
