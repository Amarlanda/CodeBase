function ReadKSDnsRPRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.RP
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.RP")
  ...
  $ResourceRecord | Add-Member TXTDomainName -MemberType NoteProperty -Value (ConvertToKSDnsDomainName $BinaryReader)
