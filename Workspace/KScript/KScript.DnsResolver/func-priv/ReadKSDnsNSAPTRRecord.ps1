function ReadKSDnsNSAPTRRecord {
  # .SYNOPSIS
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.NSAPTR
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.NSAPTR")

  # Property: Owner
  $ResourceRecord | Add-Member Owner -MemberType NoteProperty -Value (ConvertToKSDnsDomainName $BinaryReader)
