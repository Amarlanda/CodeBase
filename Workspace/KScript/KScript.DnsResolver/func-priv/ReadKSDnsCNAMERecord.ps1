function ReadKSDnsCNAMERecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolver.Message.ResourceRecord.CNAME
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.CNAME")
