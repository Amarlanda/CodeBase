function ReadKSDnsSIGRecord {
  ...
  # .OUTPUTS
  #   KScript.DnsResolverDns.Message.ResourceRecord.SIG
  # .LINK
  ...
  $ResourceRecord.PsObject.TypeNames.Add("KScript.DnsResolver.Message.ResourceRecord.SIG")
